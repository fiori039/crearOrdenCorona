sap.ui.define([
	"com/corona/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function(assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("Qmtxt").length, 1, "The sorting by Qmtxt returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by Qmtxt and there was a grouping before", function(assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("Qmtxt");
